...
const SEED_DATA: Record<string, any> = {
  ...
  tasks: [
    { id: 'task-1', title: 'Design new dashboard layout', description: 'Create a modern dashboard with charts and KPI widgets', estimatedPomodoros: 5, completedPomodoros: 3, isCompleted: false, category: 'do', keyResultId: 'kr-1', createdAt: daysAgo(2) + 'T09:00:00.000Z', todos: [], comments: [] },
    ...
    { id: 'task-3', title: 'Write API documentation', estimatedPomodoros: 4, completedPomodoros: 1, isCompleted: false, category: 'decide', createdAt: daysAgo(2) + 'T14:00:00.000Z', todos: [], comments: [] },
    ...
    { id: 'task-5', title: 'Plan sprint retrospective', estimatedPomodoros: 2, completedPomodoros: 0, isCompleted: false, category: 'decide', createdAt: daysAgo(1) + 'T08:00:00.000Z', todos: [], comments: [] },
