...
const SEED_DATA: Record<string, any> = {
  ...
  tasks: [
    ...
    { id: 'task-3', title: 'Write API documentation', estimatedPomodoros: 4, completedPomodoros: 2, isCompleted: false, category: 'decide', createdAt: daysAgo(2) + 'T14:00:00.000Z', todos: [], comments: [] },
